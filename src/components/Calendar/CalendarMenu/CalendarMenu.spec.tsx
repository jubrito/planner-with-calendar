  ...
  describe('Changing calendar dates', () => {
    ...
    describe('January', () => {
          ...
          preloadedState: {
            dateSlice: {
              currentState: {
                ...
                globalSODate: new Date(year, Months.JANUARY, 1).toDateString(),
              },
              initialState: {
      ...
      it('should go to previous month (December) when in January after clicking on button', async () => {
        ...
        expect(new Date(reduxCurrentState.globalSODate).getMonth()).toBe(
          Months.JANUARY,
        );
      ...
      it('should go to previous year (2024) when in 2025 after clicking on button', async () => {
        ...
        expect(new Date(reduxCurrentState.globalSODate).getFullYear()).toBe(
          year,
        );
        ...
        const { store } = renderWithProviders(<CalendarMenu />, {
          preloadedState: {
            dateSlice: {
              currentState: {
                ...initialValue.currentState,
                globalSODate: new Date(year, Months.DECEMBER, 1).toDateString(),
              },
              initialState: {
                ...initialValue.initialState,
                globalSODate: new Date(year, Months.DECEMBER, 1).toDateString(),
